...
# AdamW baseline for the 1B C4 runs. Steps/warmup/eval match
# HTMuonInterval_slurm.sh so the curves are directly comparable; only the
# optimizer and its lr differ (AdamW.sh used 6e-4, and takes no --lrmuon).
#
