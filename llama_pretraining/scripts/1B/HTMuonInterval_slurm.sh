...
# Rank count follows the allocation; override with GPUS=2 to dodge the warning
# above without changing --gres.
...
RUN_NAME=${RUN_NAME:-htmuon_interval_1b}
